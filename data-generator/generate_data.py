...
if __name__ == "__main__":
    ...
    # Importa para PostgreSQL (opcional)
    try:
        importar_para_postgres(df)
    except:
        print("Aviso: Conexão com PostgreSQL falhou. Apenas o CSV foi gerado.")
